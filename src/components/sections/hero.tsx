      ...
      <div className="relative z-10 mx-auto w-full max-w-[960px]">
        <div className="flex flex-col gap-6">
          ...
          <motion.p
            ...
            className="max-w-[440px] text-[15px] leading-[1.7] text-[var(--gray-8)]"
          >
            I craft interfaces where every transition, every hover state, and
            every pixel is considered. Currently building at Vercel.
          </motion.p>
